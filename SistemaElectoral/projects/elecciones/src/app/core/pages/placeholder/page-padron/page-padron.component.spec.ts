...
import { PagePadronComponent } from './page-padron.component';
import { SidebarComponent } from '../../../components/sidebar/sidebar.component';

describe('PagePadronComponent', () => {
  let component: PagePadronComponent;
  let fixture: ComponentFixture<PagePadronComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ PagePadronComponent, SidebarComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(PagePadronComponent);
  ...
  it('should render its section title', () => {
    expect(dom().querySelector('#placeholder-titulo')?.textContent).toContain('Padrón Electoral');
  });
